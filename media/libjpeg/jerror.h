  ...
  JMESSAGE(JERR_ARITH_NOTIMPL, "Sorry, arithmetic coding is not implemented")
      ...
      JMESSAGE(JERR_BAD_ALIGN_TYPE, "ALIGN_TYPE is wrong, please fix") JMESSAGE(
          ...
          "MAX_ALLOC_CHUNK is wrong, please fix") JMESSAGE(JERR_BAD_BUFFER_MODE,
                                                           "Bogus buffer "
                                                           "control mode") JMESSAGE(JERR_BAD_COMPONENT_ID,
          ...
          JMESSAGE(JERR_BAD_CROP_SPEC, "Invalid crop request")
              ...
              JMESSAGE(
                  JERR_BAD_DCT_COEF,
                  "DCT coefficient out of range") JMESSAGE(JERR_BAD_DCTSIZE,
                                                           "IDCT output "
                                                           "block size %d "
                                                           "not supported")
#if JPEG_LIB_VERSION >= 70
                  JMESSAGE(JERR_BAD_DROP_SAMPLING,
                      ...
                      JMESSAGE(
                          ...
                          "Bogus Huffman table definition") JMESSAGE(JERR_BAD_IN_COLORSPACE,
                                                                     ...
                                                                     "color"
                                                                     "spac"
                                                                     "e") JMESSAGE(JERR_BAD_J_COLORSPACE,
                              ...
                              JMESSAGE(JERR_BAD_PRECISION,
                                       ...
                                       "%d") JMESSAGE(JERR_BAD_PROGRESSION,
                                                      ...
                                                      "Al=%d") JMESSAGE(JERR_BAD_PROG_SCRIPT,
                                                                        ...
                                                                        " "
                                                                        "entry "
                                                                        "%d") JMESSAGE(JERR_BAD_SAMPLING,
                                                                                       "Bogus "
                                                                                       "samplin"
                                                                                       "g "
                                                                                       "factor"
                                                                                       "s") JMESSAGE(JERR_BAD_SCAN_SCRIPT,
                                                                                                     "Invalid scan "
                                                                                                     "script at entry %d")
                                  JMESSAGE(
                                      JERR_BAD_STATE,
                                      "Improper call to "
                                      "JPEG library in "
                                      "state %d") JMESSAGE(JERR_BAD_STRUCT_SIZE,
                                                           "JPEG parameter "
                                                           "struct "
                                                           "mismatch: "
                                                           "library thinks "
                                      ...
                                      JMESSAGE(
                                          ...
                                          "small") JMESSAGE(JERR_CANT_SUSPEND,
                                                            ...
                                                            "wed "
                                                            "her"
                                                            "e") JMESSAGE(JERR_CCIR601_NOTIMPL,
                                                                          "CCIR"
                                                                          "601 "
                                                                          "samp"
                                                                          "ling"
                                                                          ...
                                                                          "nted"
                                                                          " ye"
                                                                          "t") JMESSAGE(JERR_COMPONENT_COUNT,
                                          ...
                                          JMESSAGE(
                                              ...
                                              JMESSAGE(
                                                  ...
                                                  JMESSAGE(
                                                      ...
                                                      "not supported)") JMESSAGE(JERR_EMS_READ,
                                                                                                                              ...
                                                                                                                              JMESSAGE(
                                                                                                                                  ...
                                                                                                                                  JMESSAGE(
                                                                                                                                      ...
                                                                                                                                      "Write to XMS failed") JMESSAGE(JMSG_COPYRIGHT,
                                                                                                                                                                      JCOPYRIGHT_SHORT) JMESSAGE(JMSG_VERSION, JVERSION) JMESSAGE(JTRC_16BIT_TABLES,
                                                                                                                                                                              ...
                                                                                                                                                                              JMESSAGE(
                                                                                                                                                                                  ...
                                                                                                                                                                                  JMESSAGE(JWRN_HUFF_BAD_CODE,
                                                                                                                                                                                      ...
                                                                                                                                                                                      JMESSAGE(
                                                                                                                                                                                          ...
                                                                                                                                                                                          JMESSAGE(JERR_NO_ARITH_TABLE,
                                                                                                                                                                                                   "Arithmetic table 0x%02x was not defined") JMESSAGE(JWRN_ARITH_BAD_CODE,
                                                                                                                                                                                                                                                       "Corrupt JPEG data: bad arithmetic code")
#endif
#endif
                                                                                                                                                                                              JMESSAGE(
