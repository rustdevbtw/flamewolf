...
ICU4XCustomTimeZone_create_from_string(const char* s_data, size_t s_len);
...
diplomat_result_void_ICU4XError ICU4XCustomTimeZone_try_set_gmt_offset_seconds(
    ICU4XCustomTimeZone* self, int32_t offset_seconds);
...
diplomat_result_int32_t_ICU4XError ICU4XCustomTimeZone_gmt_offset_seconds(
    const ICU4XCustomTimeZone* self);
...
diplomat_result_void_ICU4XError ICU4XCustomTimeZone_try_set_iana_time_zone_id(
    ICU4XCustomTimeZone* self, const ICU4XIanaToBcp47Mapper* mapper,
    const char* id_data, size_t id_len);
...
diplomat_result_void_ICU4XError ICU4XCustomTimeZone_time_zone_id(
    const ICU4XCustomTimeZone* self, DiplomatWriteable* write);
...
void ICU4XCustomTimeZone_maybe_calculate_metazone(
    ICU4XCustomTimeZone* self,
    const ICU4XMetazoneCalculator* metazone_calculator,
