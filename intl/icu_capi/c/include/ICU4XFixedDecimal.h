...
ICU4XFixedDecimal_create_from_f64_with_integer_precision(double f);

diplomat_result_box_ICU4XFixedDecimal_ICU4XError
ICU4XFixedDecimal_create_from_f64_with_lower_magnitude(double f,
                                                       int16_t magnitude);

diplomat_result_box_ICU4XFixedDecimal_ICU4XError
ICU4XFixedDecimal_create_from_f64_with_significant_digits(double f,
                                                          uint8_t digits);

diplomat_result_box_ICU4XFixedDecimal_ICU4XError
ICU4XFixedDecimal_create_from_f64_with_floating_precision(double f);

diplomat_result_box_ICU4XFixedDecimal_ICU4XError
ICU4XFixedDecimal_create_from_string(const char* v_data, size_t v_len);

uint8_t ICU4XFixedDecimal_digit_at(const ICU4XFixedDecimal* self,
                                   int16_t magnitude);
...
int16_t ICU4XFixedDecimal_nonzero_magnitude_start(
    const ICU4XFixedDecimal* self);
...
void ICU4XFixedDecimal_set_sign(ICU4XFixedDecimal* self,
                                ICU4XFixedDecimalSign sign);

void ICU4XFixedDecimal_apply_sign_display(
    ICU4XFixedDecimal* self, ICU4XFixedDecimalSignDisplay sign_display);
...
void ICU4XFixedDecimal_set_max_position(ICU4XFixedDecimal* self,
                                        int16_t position);
...
diplomat_result_void_void ICU4XFixedDecimal_concatenate_end(
    ICU4XFixedDecimal* self, ICU4XFixedDecimal* other);

void ICU4XFixedDecimal_to_string(const ICU4XFixedDecimal* self,
                                 DiplomatWriteable* to);
