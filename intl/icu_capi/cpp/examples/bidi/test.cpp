...
int main() {
  ...
  std::cout << "Level of first paragraph at index 0 is " << unsigned(level)
            << std::endl;
  ...
  if (reordered != reordered) {
    std::cout << "Found incorrect reordering, expected: " << reordered
              << std::endl;
  }
  ...
  std::cout << "Level of second paragraph at index 0 is " << unsigned(level)
            << std::endl;
