...
typedef struct ICU4XPropertyValueNameToEnumMapper
...
int16_t ICU4XPropertyValueNameToEnumMapper_get_strict(
    const ICU4XPropertyValueNameToEnumMapper* self, const char* name_data,
    size_t name_len);

int16_t ICU4XPropertyValueNameToEnumMapper_get_loose(
    const ICU4XPropertyValueNameToEnumMapper* self, const char* name_data,
    size_t name_len);
...
void ICU4XPropertyValueNameToEnumMapper_destroy(
    ICU4XPropertyValueNameToEnumMapper* self);
