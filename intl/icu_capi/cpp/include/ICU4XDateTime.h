...
ICU4XDateTime_create_from_iso_in_calendar(int32_t year, uint8_t month,
...
ICU4XDateTime* ICU4XDateTime_create_from_date_and_time(const ICU4XDate* date,
...
ICU4XDateTime* ICU4XDateTime_to_calendar(const ICU4XDateTime* self,
                                         const ICU4XCalendar* calendar);
