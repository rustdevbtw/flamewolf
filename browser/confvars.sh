...
MOZ_APP_UA_NAME=FlameWolf
MOZ_APP_VENDOR=FlameWolf
MOZ_BRANDING_DIRECTORY=browser/branding/flamewolf
MOZ_OFFICIAL_BRANDING_DIRECTORY=browser/branding/flamewolf
