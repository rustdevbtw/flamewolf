...
drm-content-header = Digital Rights Management (DRM) Content [Sell your Freedom]

play-drm-content =
    .label = Allow DRM (aka sell your freedom)
    .accesskey = D

play-drm-content-learn-more = Learn more about how DRM takes your freedom, and then decide about enabling it!
