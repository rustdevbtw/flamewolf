...
void UpdateAccumulatedError(
    ...
    float one_over_error_sum_anchor, float smooth_constant_increases) {
...
size_t ComputePreEchoLag(
    ...
    const rtc::ArrayView<const float> accumulated_error, size_t lag,
...
MatchedFilter::MatchedFilter(
    ...
    float excitation_limit, float smoothing_fast, float smoothing_slow,
    float matching_filter_threshold, bool detect_pre_echo)
