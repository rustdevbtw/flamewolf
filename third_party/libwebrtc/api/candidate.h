...
class RTC_EXPORT Candidate {
 public:
  ...
  [[deprecated("Use IceCandidateType version")]] Candidate(
      int component, absl::string_view protocol,
      const rtc::SocketAddress& address, uint32_t priority,
      absl::string_view username, absl::string_view password,
      absl::string_view type ABSL_ATTRIBUTE_LIFETIME_BOUND, uint32_t generation,
      absl::string_view foundation, uint16_t network_id = 0,
      uint16_t network_cost = 0);
